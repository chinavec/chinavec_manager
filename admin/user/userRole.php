...
<script type="text/javascript">
	...
	$(function(){
			$("<img src='../../img/lbg.gif'></img>").appendTo("#container_left ul li.userRole");
	});
</script>
<style>
	#container_left ul li.userRole{background-color:#108dbd;}
	#container_left ul li.userRole a{color:#FFF;}
</style>
</head>
        	...
        	<table class="ctable" width="90%">
				...
				FROM `user_role` where `id`={$item->user_role_id};",'');
                        ...
                        <td width="50%" align="center"><?php  
															...
															$arr=explode("/",$item->user_right_id);
															//print_r($arr);
															//echo count($arr);exit;
				...
				FROM `user_right` where `id`={$arr[$i]};",'');
																$str.=$arr_authority->name."/";
