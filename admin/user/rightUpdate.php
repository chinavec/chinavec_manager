<?php
	...
	$array=$dba->select("select * from `user_right` where `id`='{$id}'");
	//print_r($arr);exit;
	//print_r($array[0]->name);exit;
    ...
    <div id="container" class="clearfix">
        ...
        <div id="container_right" class="right">
			...
			<p>&nbsp;</p>  <hr />
     		...
     		<form id="createRight" name="createRight" action="rightDoUpdate.php?id=<?php echo $id;?>" method="post">
			    <table width="60%" border="0" cellspacing="0" cellpadding="0" style="margin-left:20%">
			   	    <tr>
                        <td width="20%" height="60px">权限名称：</td>
                        <td width="40%"><input type="text" id="name" name="name" style="width:200px;" value="<?php echo $array[0]->name;?>"/></td>
			...
			<tr>
                    	...
                    	-->
					<tr>
                        <td height="60px"><input type="submit" value="保存"  id="createRole_submit"/></td>
