...
<ul id="nav" class="clearfix nav nav-pills">
    <!--
    <li>
    ...
    -->
    <li class="active">
        <a href="../admin/user/userRole.php">用户管理</a>
        <ul class="sub_nav" style="width:90px">
            ...
            -->
            <li><a href="../admin/user/userRole.php">用户角色管理</a></li>
            <li><a href="../admin/user/userRight.php">用户权限管理</a></li>
            <li><a href="../admin/user/user.php">用户信息管理</a></li>
        </ul>
    </li>
<!--
    <li class="unactive">
...
-->
    ...
    <li class="unactive">
        <a href="../../chinavec_business/support/newvisitSite.php">业务支持</a>
